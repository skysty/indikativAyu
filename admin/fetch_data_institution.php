...
include('../incs/connect.php');
        ...
        WHERE faculties.activ = 0 and cafedras.activ=1
    ...
    while ($cafedra = mysqli_fetch_array($c_sql)) {
        ...
        if ($_SESSION['lang'] != 'kaz'){
            $sTitle = isset($cafedra['cafedraNameTR']) && mb_strlen($cafedra['cafedraNameTR']) ? $cafedra['cafedraNameTR'] : $cafedra['cafedraNameTR'];
        }
