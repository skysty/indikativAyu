...
<?php
	...
	<title><?=$oL::get('Еңбекті жүктеу ОПҚ')?></title>
	...
	<div class = "content">
		<div class = "content_wrapper" style = "margin-top: 5px;">
			<div class = "inner_conten" style = "width: 1000px; margin: 0 auto;">
				<h2 style = "text-align: center;"><?= $oL::get('Орталықтандырылған ендіру (ОПҚ үшін)')?></h2>			
				<?php
				...
				*/
					...
					WHERE mail = '$tutor_id'") or die(mysqli_error());
					...
					function load_korsetkish(){
						...
						global $connection;
						$output = '';
						$sql = "SELECT * FROM korsetkishter WHERE bolimderID IN(1,3,5,6,7) and typeID='$tt'";
				...
				<div class = "select_box">
					...
					<?=$oL::get('Көрсеткіштер')?>
						...
						<label for="sany" id = "label_sany"><?=$oL::get('Саны')?></label><br /><input type = "number" id = "sany" name = "sany" value = "1" step="0.01" min="0.01"><br /><br />
						<label for="ball" id = "ball"><?=$oL::get('Балы')?></label><br /><input type = "text" id = "ball" name = "ball" value = "1" step="0.01" min="0.01"><br /><br />
						...
						<!--<br>Деректер қоры жабылды! 01.06.2020 00:00<br/>-->
                                                <input type = "submit" name = "upopk" value = "<?=$oL::get('Жүктеу')?>"/>
					</form>
				</div>
				<div class = "works">
					<style>
