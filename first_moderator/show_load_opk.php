...
<div class = "header">
	...
	<div class = "content">
		...
		<div class = "content_wrapper" style = "width: 100%; margin: 0 auto; margin-top: 5px;">	
			...
			<h2 style = "text-align: center; padding-top: 10px;"><span style = "color: red;">[</span><?=$oL::get('Сіздің балл сәтті қосылды!!!')?><span style = "color: red;">]</span></h2>
			...
			<?php
				...
				echo '<meta http-equiv="refresh" content="2;url=enbek_jukteuopk.php">';
