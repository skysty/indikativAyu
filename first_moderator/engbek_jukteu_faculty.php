...
<?php
	...
	<title><?=$oL::get('Еңбекті жүктеу')?></title>
	...
	<div class = "content">
		...
		<div class = "content_wrapper" style = "margin-top: 5px;">
			...
			<div class = "inner_conten" style = "width: 1000px; margin: 0 auto;">
				...
				<h2 style = "text-align: center;"><?= $oL::get('Орталықтандырылған ендіру (Факультет немесе ҒЗО)')?></h2>			
				...
				*/
				...
				<div class = "select_box">
					...
					<?=$oL::get('Көрсеткіштер')?>
						...
						<input type = "date" name = "date"  required placeholder = "жжжж-аа-кк"/><br /><br />
						...
						<input type = "file" name="file" accept="application/pdf, image/*" required placeholder="Файлды жүктеңіз"/><br /><br /><hr />
				...
				<tbody>
					<?php
						...
						WHERE mail = '$tutor_id' and engbekter.del=0 and engbekter.kod_kafedra IS NULL   ORDER BY engbekter.engbekID DESC";
