			...
			<div class = "shagymTable">
				...
				<table>
					...
					<?php
						...
						$query = mysqli_query($connection,"SELECT shagymdar.shagymID, 
						shagymdar.shagym, 
						...
						while($shagym = mysqli_fetch_array($query)){
                            ...
                            if ($_SESSION['lang'] != 'kaz'){
                                $sLastName = isset($shagym['lastnameTR']) && mb_strlen($shagym['lastnameTR']) ? $shagym['lastnameTR'] : $shagym['lastname'];
                                $sFirstName = isset($shagym['firstnameTR']) && mb_strlen($shagym['firstnameTR']) ? $shagym['firstnameTR'] : $shagym['firstname'];
                            }
