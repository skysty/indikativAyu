				...
				<div class = "inner_conten" style = "width: 1000px; margin: 0 auto;">
					...
					<div id="dialog">
						<div class="dialog-content">
							...
							<p style="color:red">Ескерту:2.1 - 2.1.6 аралығындағы көрсеткіштерге еңбек салу ересжесі өзгерді</p>
							<p style="color:red">Авторлар санын жазасыз</p>
							<p style="color:red">Ескерту сипаттамасына авторлардың аттарын жазып шығасыз бас автордан төмен қарай</p>
							<p style="color:red">Мысалы: Егер автор 4 еу болса 1)Жүнісбек Сәкен Болатұлы 2)Анеш Болат Мүсирбекович 3)Сейсен Марат Исабекулы 4)Утебаев Баймурат </p>
					...
					<?php
						...
						$tut = $tutor['TutorID'];
							function load_korsetkish(){
								...
								global $tut;
								$output = '';
								$sql = "SELECT distinct * FROM korsetkishter k
								join dostupkorset d on d.korsetkishID = k.kod_korsetkish
								WHERE k.bolimderID='1' and d.dostup=0 and d.tutorID=$tut";
					...
					<div class = "select_box">
						<form id="form1" method = "post" action = "load_engbek_apel.php" style = "margin-top: 10px;" enctype = "multipart/form-data">
							Көрсеткіштер
							...
							<input type = "hidden" name = "save_date" value = "<?php date_default_timezone_set("Asia/Dhaka"); echo date("d/m/Y H:i:s");?>"/>						
										<!--			<br>Деректер қоры жабылды! 11.06.2024 00:00<br/>-->
