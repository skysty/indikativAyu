	...
	if(isset($_POST['upload'])){
		...
		if($file_size == FALSE){
			...
			if($b < $a){
				...
				$query = mysqli_query($connection,"INSERT INTO engbekter(kod_korset, kod_kizm, kod_okujil, kod_univer, kod_fakul,  sani, kuni,  file_ati, rastalu, ball, eskertu, kod_stat, artik, ball8, saktalgan_kuni) VALUES('$korsetkish','$TutorID','11','1','$FacultyID','$sani','$date','../files/$newfilename','-','0','$eskertu','2','0','0','$save_date')") or die(mysqli_error($connection));
				header('Location: show_load_f.php');
			} else {
