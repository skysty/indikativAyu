...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	...
	<body>
		...
		<div class = "content_wrapper" style = "width: 100%; margin: 0 auto; margin-top: 5px;">	
			<h2 style = "text-align: center; padding-top: 10px;"><span style = "color: red;">[</span><?= $oL::get('Сіздің еңбегіңіз сәтті жүктелді!!!')?><span style = "color: red;">]</span></h2>
			<?php
				...
				echo '<meta http-equiv="refresh" content="2;url=engbek_jukteu.php">';
