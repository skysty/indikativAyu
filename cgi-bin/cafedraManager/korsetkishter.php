...
<head>
	...
	?>
	<title><?php= $oL::get('Көрсеткіштер')?></title>
...
<?php
			...
			while($korsetkish = mysqli_fetch_array($query)){
				...
				$kors = $korsetkish['korsetkish_ati2'];
			    echo "<tr><td>" . $korsetkish['kod_korsetkish'] ."</td><td>".$kors."</td><td>".$oL::get($korsetkish['olshem'])."</td><td>" . $korsetkish['ball'] . "</td></tr>";
			}
		    ?>
