...
if(isset($_POST['submit']))
{
	...
	{
		$msg = "Бұл электрондық пошта біздің дерекқорымызда жоқ. (DULATY.kz) почтасына тіркеліңіз";
				 $msgclass = 'bg-danger';
	}
}
	...
	<div class="row">
    	...
    	<div class="col-lg-4 col-lg-offset-4">        
        	...
        	<form class="form-horizontal" role="form" method="post">
                ...
                <div class="row">
                    <div class="col-lg-12">
                    <label class="control-label">Сіздің электрондық поштаңыз (dulaty.kz)</label>
                    </div>
                </div>
