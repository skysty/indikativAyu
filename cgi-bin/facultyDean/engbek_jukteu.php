						...
						$tut = $tutor['TutorID'];
							...
							function load_korsetkish(){
								...
								while($row = mysqli_fetch_array($result)){
                                   				 $korsetkish_ati = $row['korsetkish_ati'];
                                    				if ($_SESSION['lang'] != 'kaz'){
                                        			$korsetkish_ati = $oL::get($row['korsetkish_ati']);
                                    				}

									$output .= '<option id_esep="'.$row["id_esep"].'" id_comment="'.$row["id_comment"].'" value = "'.$row["kod_korsetkish"].'" id_shekteu="'.$row["id_shekteu"].'">' . $korsetkish_ati . '</option>';
