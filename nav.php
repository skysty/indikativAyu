            ...
            <li><a href="#"><?= $oL::get('Негізгі')?></a>
		        <ul>
				    ...
				    <ul>                             
                        ...
                        <li><a target = "_blank" href = "../files/aleumettik23.pdf"><?= $oL::get('Әлеуметтік-мәдени бағыт - Растаушылар')?></a></li>
                        ...
                        <li><a target = "_blank" href = "../files/doc1.pdf"><?= $oL::get('Ішкі кәсіби рейтинг коммиссиясы мәжілісінің хаттамалары')?></a></li>
						<li><a target = "_blank" href = "../files/hattama2023.pdf"><?= $oL::get('Хаттама №1  - Рейтинг комиссия 2023')?></a></li>
                        <li><a target = "_blank" href = "../files/hattama2023-2024.pdf"><?= $oL::get('Хаттама № 1, 2023-2024 ж.pdf')?></a></li>
                    </ul>
			</li>  
                   <li>
