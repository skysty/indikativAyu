...
<div class = "header">
	...
	<div class = "content">
		...
		<div class = "content_wrapper" style = "width: 100%; margin: 0 auto; margin-top: 5px;">	
			...
			<h2 style = "text-align: center; padding-top: 10px;"><span style = "color: red;">[</span><?=$oL::get('Сәтті рұқсат берілді !!!')?><span style = "color: red;">]</span></h2>
			...
			<?php
				...
				$_SESSION['tutor'];
				echo '<meta http-equiv="refresh" content="2;url=dostup_opk.php">';
